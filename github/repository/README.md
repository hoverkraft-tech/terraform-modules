...
| <a name="input_allow_merge_commit"></a> [allow\_merge\_commit](#input\_allow\_merge\_commit) | Set to true to allow merge commits | `bool` | `true` | no |
...
| <a name="input_allow_squash_merge"></a> [allow\_squash\_merge](#input\_allow\_squash\_merge) | Set to true to allow squash merges | `bool` | `true` | no |
...
| <a name="input_delete_branch_on_merge"></a> [delete\_branch\_on\_merge](#input\_delete\_branch\_on\_merge) | Set to true to delete head branches when pull requests are merged | `bool` | `false` | no |
...
| <a name="input_web_commit_signoff_required"></a> [web\_commit\_signoff\_required](#input\_web\_commit\_signoff\_required) | Set to true to require contributors to sign off on web-based commits | `bool` | `false` | no |
