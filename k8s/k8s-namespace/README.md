...
|------|-------------|------|---------|:--------:|
| <a name="input_annotations"></a> [annotations](#input\_annotations) | Annotations to add to the namespace | `map(any)` | `{}` | no |
...
| <a name="input_labels"></a> [labels](#input\_labels) | Labels to add to the namespace | `map(any)` | `{}` | no |
